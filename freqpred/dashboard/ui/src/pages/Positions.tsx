              ...
              <tbody>
                {data.items.map((p) => (
                  <tr key={p.id} className="border-t hover:bg-gray-50">
                    ...
                    <td className={`px-3 py-2 text-center ${pnlColor(p.pnl)}`}>
                      {p.pnl !== null ? `$${fmt(p.pnl)}` : '—'}
                    </td>
                    <td className={`px-3 py-2 text-center ${pnlColor(p.pnl_pct)}`}>
                      {fmtPct(p.pnl_pct)}
                    </td>
                ...
                {data.items.length === 0 && (
                  <tr>
                    <td colSpan={10} className="px-3 py-6 text-center text-gray-400">No positions</td>
                  </tr>
                )}
              </tbody>
            </table>
